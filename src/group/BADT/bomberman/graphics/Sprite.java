...
public class Sprite {
	...
	private characterSheet1 _charactersheet2sheet2;
...
//	public static Sprite grass = new Sprite(16, 8, 4, SpriteSheet1.tiles, 16, 16);
	public static Sprite grass = new Sprite(16, 22, 20, SpriteSheet2.tiles, 14, 12);
	public static Sprite brick = new Sprite(16, 6, 7, SpriteSheet2.tiles, 16, 16);
	...
	public static Sprite player_up = new Sprite(21, 2, 0, characterSheet1.tiles, 15, 16);
	public static Sprite player_down = new Sprite(21, 0, 0, characterSheet1.tiles, 12, 15);
	public static Sprite player_left = new Sprite(21, 1, 0, characterSheet1.tiles, 10, 15);
	public static Sprite player_right = new Sprite(21, 3, 0, characterSheet1.tiles, 16, 16);

	public static Sprite player_up_1 = new Sprite(21, 2, 1, characterSheet1.tiles, 12, 16);
	public static Sprite player_up_2 = new Sprite(21, 2, 2, characterSheet1.tiles, 12, 15);

	public static Sprite player_down_1 = new Sprite(21, 0, 1, characterSheet1.tiles, 12, 15);
	public static Sprite player_down_2 = new Sprite(21, 0, 2, characterSheet1.tiles, 12, 16);

	public static Sprite player_left_1 = new Sprite(21, 1, 1, characterSheet1.tiles, 11, 16);
	public static Sprite player_left_2 = new Sprite(21, 1, 2, characterSheet1.tiles, 12 ,16);

	public static Sprite player_right_1 = new Sprite(21, 3, 1, characterSheet1.tiles, 11, 16);
	public static Sprite player_right_2 = new Sprite(21, 3, 2, characterSheet1.tiles, 12, 16);
	...
	// Ovape
	public static Sprite Ovape_left1 = new Sprite(16, 4,  5, SpriteSheet.tiles, 16, 16);
	public static Sprite Ovape_left2 = new Sprite(16, 4,  6, SpriteSheet.tiles, 16, 16);
	public static Sprite Ovape_left3 = new Sprite(16, 4,  7, SpriteSheet.tiles, 16, 16);


	public static Sprite Ovape_right1 = new Sprite(16, 5,  5, SpriteSheet.tiles, 16, 16);
	public static Sprite Ovape_right2 = new Sprite(16, 5,  6, SpriteSheet.tiles, 16, 16);
	public static Sprite Ovape_right3 = new Sprite(16, 5,  7, SpriteSheet.tiles, 16, 16);

	public static Sprite Ovape_dead = new Sprite(16, 4, 8, SpriteSheet.tiles, 16, 16);
	...
	public static Sprite Pass_dead = new Sprite(16, 6, 8, SpriteSheet.tiles, 16,16 );


	// Potan
	public static  Sprite Potan_left1 = new Sprite(16, 12, 5, SpriteSheet.tiles, 16, 16);
	public static  Sprite Potan_left2 = new Sprite(16, 12, 6, SpriteSheet.tiles, 16, 16);
	public static  Sprite Potan_left3 = new Sprite(16, 12, 7, SpriteSheet.tiles, 16, 16);

	public static  Sprite Potan_right1 = new Sprite(16, 13, 5, SpriteSheet.tiles, 16, 16);
	public static  Sprite Potan_right2 = new Sprite(16, 13, 6, SpriteSheet.tiles, 16, 16);
	public static  Sprite Potan_right3 = new Sprite(16, 13, 7, SpriteSheet.tiles, 16, 16);

	public static  Sprite Potan_dead = new Sprite(16, 12, 8, SpriteSheet.tiles, 16, 16);
	...
	public Sprite(int size, int x, int y, characterSheet1 sheet2, int rw, int rh) {
		sheet2.tiles._path = "/textures/BlackBbomber.png";
		SIZE = size;
		_pixels = new int[SIZE * SIZE];
		_x = x * SIZE;
		_y = y * SIZE;
		_charactersheet2sheet2 = sheet2;
		_realWidth = rw;
		_realHeight = rh;
		loadchar2();
	}
	...
	private void loadchar2() {
		for (int y = 0; y < SIZE; y++) {
			for (int x = 0; x < SIZE; x++) {
				_pixels[x + y * SIZE] = _charactersheet2sheet2._pixels[(x + _x) + (y + _y) * _charactersheet2sheet2.SIZE];
			}
		}
	}
	...
	public static void characterConverter () {
		player_up = new Sprite(21, 2, 0, characterSheet1.tiles1, 15, 16);
		player_down = new Sprite(21, 0, 0, characterSheet1.tiles1, 12, 15);
		player_left = new Sprite(21, 1, 0, characterSheet1.tiles1, 10, 15);
		player_right = new Sprite(21, 3, 0, characterSheet1.tiles1, 16, 16);

		player_up_1 = new Sprite(21, 2, 1, characterSheet1.tiles1, 12, 16);
		player_up_2 = new Sprite(21, 2, 2, characterSheet1.tiles1, 12, 15);

		player_down_1 = new Sprite(21, 0, 1, characterSheet1.tiles1, 12, 15);
		player_down_2 = new Sprite(21, 0, 2, characterSheet1.tiles1, 12, 16);

		player_left_1 = new Sprite(21, 1, 1, characterSheet1.tiles1, 11, 16);
		player_left_2 = new Sprite(21, 1, 2, characterSheet1.tiles1, 12 ,16);

		player_right_1 = new Sprite(21, 3, 1, characterSheet1.tiles1, 11, 16);
		player_right_2 = new Sprite(21, 3, 2, characterSheet1.tiles1, 12, 16);
	}
	...
	public static void drawArray1(Graphics2D g, FontSheet f, String word, Vector2f pos, int width, int height, int xOffset, int yOffset) {
		float x = pos.x;
		float y = pos.y;
