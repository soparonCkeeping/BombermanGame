...
import group.BADT.bomberman.entities.character.enemy.findDir.Direct;
...
public abstract class Enemy extends Character {
	...
	public Enemy(int x, int y, Board board, Sprite dead, double speed, int points) {
		...
		MAX_STEPS = TimeLooping.TILES_SIZE / _speed;
	...
	public boolean canMove(double x, double y) {
		...
		int xx = PosTypeTrans.pixelToTile(xr) +(int)x;
		int yy = PosTypeTrans.pixelToTile(yr) +(int)y;
	...
	public void kill() {
		...
		_board.addMessage(msg);
                MusicStuff.play("Getcoin");
                MusicStuff.play("defeat");
	}
